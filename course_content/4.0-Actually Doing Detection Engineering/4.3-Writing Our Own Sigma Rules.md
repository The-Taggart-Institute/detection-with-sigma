...
**TODO** Make infographic of: Ideation Phase -> Log Generation -> Sigma Conversion -> Testing -> Playbook Development -> Production Deployment
...
From here I will begin to work in the opposite direction of what we use the pipelines for up until this point and take that log entry I found, pick out the unique fields that capture the malicious behavior, and replace them with the generalized feilds used by the Sigma community. During this stage I also try to build the logic of my detection where I define the keywords that I am looking for and the elements I'd like to filter out all while avoiding the trappings of the true postive and false negative scenarios. 
...
**TODO** Probably want a threat intel doc describing an attack and ask the student to write a detection and matching pipeline
